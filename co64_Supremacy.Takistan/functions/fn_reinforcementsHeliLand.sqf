...
>> sends helicopter carrying troops to the AO (heli will land)
...
tf47_var_reinforcements_helipad = "Land_HelipadEmpty_F" createVehicle _landPos;
...
[_grp, 1] setWaypointStatements ["true", "deleteVehicle tf47_var_reinforcements_helipad; tf47_var_reinforcements_heliUnarmed = 0;"];
